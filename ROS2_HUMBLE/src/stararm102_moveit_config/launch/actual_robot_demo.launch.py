...
def generate_launch_description():
    ...
    robo_state_publisher_launch = os.path.join(get_package_share_directory('stararm102_description'),'launch')
    ...
    robo_moveit_rviz_launch = os.path.join(get_package_share_directory('stararm102_moveit_config'),'launch')
