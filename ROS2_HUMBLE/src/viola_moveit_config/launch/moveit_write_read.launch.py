...
def generate_launch_description():
    ...
    robo_moveit_write_launch = os.path.join(get_package_share_directory('viola_moveit_config'),'launch')
    ...
    robo_moveit_read_launch = os.path.join(get_package_share_directory('viola_moveit_config'),'launch')
